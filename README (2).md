...
![Robotics Support Assistant Screenshot](INSERT_SCREENSHOT_HERE)
...
![Chatbot Demo](INSERT_SCREENSHOT_HERE)

Example interaction:

**User:**
> My servo motor is not working.

**Assistant:**
> Check that the motor is receiving power and verify that the motor connections are secure. You should also review communication between the motor controller and your software.
...
```
timestamp,question,response,response_length
```
